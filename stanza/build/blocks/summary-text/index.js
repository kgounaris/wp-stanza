...
/***/ "./src/blocks/summary-text/block.json":
/*!********************************************!*\
  !*** ./src/blocks/summary-text/block.json ***!
  \********************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"apiVersion":3,"name":"stanza/summary-text","title":"Summary text","category":"text","description":"Write clear summary using up to two paragraphs.","attributes":{"align":{"type":"string"},"backgroundColor":{"type":"string"},"maxParagraphs":{"type":"number","default":3},"parentId":{"type":"string"},"template":{"type":"array"},"summaryTextOptions":{"type":"object","default":{}}},"supports":{"align":true,"anchor":true,"inserter":true,"__experimentalHasCustomAppender":true},"editorScript":"file:./index.js"}');

/***/ }),

/***/ "./src/blocks/summary-text/edit.js":
/*!*****************************************!*\
  !*** ./src/blocks/summary-text/edit.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function Edit({
  ...
  // Set align layout and default background
  (0,_helpers__WEBPACK_IMPORTED_MODULE_6__.setAlignLayoutBackground)('stanza/summary-text', clientId, setAttributes, backgroundColor, align, layout, parentId);
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
    className: ['wp-block', backgroundColor ? `has-${backgroundColor}-background-color has-background-color` : '', 'is-layout-flow'].filter(Boolean).join(' ')
  });
  ...
  const lastNoticeTs = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useRef)(0); // throttle notices to avoid spam on paste
  //.
  ...
  const {
    ...
    const s = select(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.store);
    return {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    if (childIds.length > maxParagraphs) {
      ...
      if (now - lastNoticeTs.current > 500) {
        createNotice('warning', (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('You can only add up to %d paragraphs.', 'stanza'), maxParagraphs), {
          type: 'snackbar',
          isDismissible: true
        });
  ...
  const innerBlocksProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useInnerBlocksProps)({}, {
    ...
    templateLock: false,
    renderAppender: () => canAddMore ? /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InnerBlocks.DefaultBlockAppender, {}) : null
  });
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Fragment, {
    children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.InspectorControls, {
      ...
      group: "styles",
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_components__WEBPACK_IMPORTED_MODULE_5__.StanzaPanelColorSettings, {
...
/***/ "./src/blocks/summary-text/save.js":
/*!*****************************************!*\
  !*** ./src/blocks/summary-text/save.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function save({
  ...
  const blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.useBlockProps.save({
    className: ['wp-block', backgroundColor && !parentId ? `has-${backgroundColor}-background-color has-background-color` : '', 'is-layout-flow'].filter(Boolean).join(' ')
  });
...
(() => {
/*!******************************************!*\
  !*** ./src/blocks/summary-text/index.js ***!
  \******************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/summary-text/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/summary-text/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/summary-text/save.js");
...
_block_json__WEBPACK_IMPORTED_MODULE_1__ = (0,_helpers__WEBPACK_IMPORTED_MODULE_6__.supportsByOptions)('stanza/summary-text', _block_json__WEBPACK_IMPORTED_MODULE_1__);

// Overwrite attributes defaults using stanza.json options
_block_json__WEBPACK_IMPORTED_MODULE_1__ = (0,_helpers__WEBPACK_IMPORTED_MODULE_6__.defaultsByOptions)('stanza/summary-text', _block_json__WEBPACK_IMPORTED_MODULE_1__);

// Set options using stanza.json options
_block_json__WEBPACK_IMPORTED_MODULE_1__ = (0,_helpers__WEBPACK_IMPORTED_MODULE_6__.setBlockOptionsAttribute)('stanza/summary-text', _block_json__WEBPACK_IMPORTED_MODULE_1__, 'summaryTextOptions');
...
// Register styles using stanza.json options
(0,_helpers__WEBPACK_IMPORTED_MODULE_6__.registerBlockStyles)('stanza/summary-text');

// Register variations using stanza.json options
(0,_helpers__WEBPACK_IMPORTED_MODULE_6__.registerBlockVariations)('stanza/summary-text');
})();

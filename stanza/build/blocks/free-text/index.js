...
/***/ "./src/blocks/free-text/block.json":
/*!*****************************************!*\
  !*** ./src/blocks/free-text/block.json ***!
  \*****************************************/
/***/ ((module) => {

module.exports = /*#__PURE__*/JSON.parse('{"apiVersion":3,"name":"stanza/free-text","title":"Free text","category":"text","description":"Add and format text freely within your layout.","attributes":{"align":{"type":"string"},"allowedBlocks":{"type":"array"},"backgroundColor":{"type":"string"},"template":{"type":"array"},"parentId":{"type":"string"},"freeTextOptions":{"type":"object","default":{}}},"supports":{"anchor":true,"align":true,"layout":{"allowCustomContentAndWideSize":false,"default":{"type":"default","justifyContent":"center"}}},"editorScript":["stanza-config","file:./index.js"]}');

/***/ }),

/***/ "./src/blocks/free-text/edit.js":
/*!**************************************!*\
  !*** ./src/blocks/free-text/edit.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
(0,_utilities__WEBPACK_IMPORTED_MODULE_5__.monitorBlockFocus)('stanza/free-text'); // TODO: run here?
...
function Edit({
  ...
  (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.setAlignLayoutBackground)('stanza/free-text', clientId, setAttributes, backgroundColor, align, layout, parentId);
  const blockProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useBlockProps)({
    className: ['wp-block', 'is-layout-flow', backgroundColor ? `has-${backgroundColor}-background-color has-background-color` : ''].filter(Boolean).join(' ')
  });
  const innerBlocksProps = (0,_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.useInnerBlocksProps)(blockProps, {
    layout: layout,
    template: template || TEMPLATE,
    templateLock: false,
    allowedBlocks: allowedBlocks || ['core/heading', 'core/paragraph', 'core/list', 'core/list-item', 'core/quote', 'core/table', 'stanza/media', 'stanza/button', 'stanza/slider']
  });
...
function save({
  ...
  const blockProps = _wordpress_block_editor__WEBPACK_IMPORTED_MODULE_0__.useBlockProps.save({
    className: ['wp-block', 'is-layout-flow', backgroundColor && !parentId ? `has-${backgroundColor}-background-color has-background-color` : ''].filter(Boolean).join(' ')
  });
...
(() => {
/*!***************************************!*\
  !*** ./src/blocks/free-text/index.js ***!
  \***************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @wordpress/blocks */ "@wordpress/blocks");
/* harmony import */ var _wordpress_blocks__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_wordpress_blocks__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/free-text/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/free-text/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/free-text/save.js");
...
_block_json__WEBPACK_IMPORTED_MODULE_1__ = (0,_helpers__WEBPACK_IMPORTED_MODULE_6__.supportsByOptions)('stanza/free-text', _block_json__WEBPACK_IMPORTED_MODULE_1__);

// Overwrite attributes defaults using stanza.json options
_block_json__WEBPACK_IMPORTED_MODULE_1__ = (0,_helpers__WEBPACK_IMPORTED_MODULE_6__.defaultsByOptions)('stanza/free-text', _block_json__WEBPACK_IMPORTED_MODULE_1__);
...
// Register styles using stanza.json options
(0,_helpers__WEBPACK_IMPORTED_MODULE_6__.registerBlockStyles)('stanza/free-text');

// Register variations using stanza.json options
(0,_helpers__WEBPACK_IMPORTED_MODULE_6__.registerBlockVariations)('stanza/free-text');
})();

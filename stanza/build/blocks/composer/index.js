...
module.exports = /*#__PURE__*/JSON.parse('{"apiVersion":3,"name":"stanza/composer","title":"Block composer","icon":"grid-view","category":"design","description":"Combine multiple blocks to create rich, custom layouts.","attributes":{"align":{"type":"string"},"backgroundColor":{"type":"string"},"template":{"type":"array"},"mediaPosition":{"type":"string"},"useInnerBlockWrapper":{"type":"boolean","default":true}},"supports":{"align":true,"anchor":true,"inserter":false,"layout":{"allowCustomContentAndWideSize":false,"default":{"type":"default","justifyContent":"center"}}},"editorScript":["file:./index.js"]}');

/***/ }),

/***/ "./src/blocks/composer/edit.js":
/*!*************************************!*\
  !*** ./src/blocks/composer/edit.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _utilities__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utilities */ "./src/blocks/utilities.js");
...
function Edit({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.Fragment, {
    children: [window?.Stanza?.blocks[blockName || 'stanza/composer']?.attributes?.mediaPosition?.options.length && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_1__.BlockControls, {
      ...
      children: [archiveBlock?.[1]?.postType && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_wordpress_components__WEBPACK_IMPORTED_MODULE_2__.PanelBody, {
        title: "Help",
        initialOpen: true,
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsxs)("p", {
          children: ["Contains archive. Check the ", archiveBlock[1].postType, " ", /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)("a", {
            href: `edit.php?post_type=${archiveBlock[1].postType}`,
            target: "_blank",
            rel: "noopener noreferrer",
            children: "edit screen"
          }), " to edit content."]
        })
      }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_components__WEBPACK_IMPORTED_MODULE_3__.StanzaAttrsPanelBody, {
      ...
      group: "styles",
      children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_7__.jsx)(_components__WEBPACK_IMPORTED_MODULE_3__.StanzaPanelColorSettings, {
        setAttributes: setAttributes,
        colorAttribute: backgroundColor,
        palette: window?.Stanza?.blocks[blockName || 'stanza/composer']?.attributes?.backgroundColor?.options
      })
    }), (useInnerBlockWrapper !== null && useInnerBlockWrapper !== void 0 ? useInnerBlockWrapper : true) ?
    /*#__PURE__*/
    // undefined for preexisting blocks without useInnerBlockWrapper
...
function save({
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_1__.Fragment, {
    children: (useInnerBlockWrapper !== null && useInnerBlockWrapper !== void 0 ? useInnerBlockWrapper : true) ?
    /*#__PURE__*/
    // undefined for preexisting blocks without useInnerBlockWrapper
...
/* harmony import */ var _block_json__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./block.json */ "./src/blocks/composer/block.json");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./edit */ "./src/blocks/composer/edit.js");
/* harmony import */ var _save__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save */ "./src/blocks/composer/save.js");
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../helpers */ "./src/blocks/helpers.js");
...
// Overwrite supports using stanza.json options
_block_json__WEBPACK_IMPORTED_MODULE_1__ = (0,_helpers__WEBPACK_IMPORTED_MODULE_4__.supportsByOptions)('stanza/composer', _block_json__WEBPACK_IMPORTED_MODULE_1__);

// Overwrite attributes defaults using stanza.json options
_block_json__WEBPACK_IMPORTED_MODULE_1__ = (0,_helpers__WEBPACK_IMPORTED_MODULE_4__.defaultsByOptions)('stanza/composer', _block_json__WEBPACK_IMPORTED_MODULE_1__);
...
// Register styles using stanza.json options
(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.registerBlockStyles)('stanza/composer');

// Register variations using stanza.json options
(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.registerBlockVariations)('stanza/composer');

// Register block types using stanza.json options
(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.registerBlockTypes)('stanza/composer');
})();

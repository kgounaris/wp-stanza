...
document.addEventListener('DOMContentLoaded', () => {
  document.querySelectorAll('.wp-block-stanza-slider .swiper-container').forEach(container => {
    var _settings$effect, _settings$direction, _settings$allowTouchM;
    ...
    const swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"](container, {
      modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.EffectFade],
      effect: (_settings$effect = settings?.effect) !== null && _settings$effect !== void 0 ? _settings$effect : 'slide',
      wrapperClass: 'swiper-wrapper',
      direction: (_settings$direction = settings?.direction) !== null && _settings$direction !== void 0 ? _settings$direction : "horizontal",
      ...
      allowTouchMove: (_settings$allowTouchM = settings?.allowTouchMove) !== null && _settings$allowTouchM !== void 0 ? _settings$allowTouchM : true,

...
module.exports = /*#__PURE__*/JSON.parse('{"apiVersion":3,"name":"stanza/accordion","title":"Accordion","category":"layout","icon":"menu","description":"Organize your content in an easy-to-toggle accordion.","attributes":{"align":{"type":"string"},"backgroundColor":{"type":"string"},"parentId":{"type":"string"},"template":{"type":"array"}},"supports":{"anchor":true,"align":true,"layout":{"allowCustomContentAndWideSize":false,"default":{"type":"default","justifyContent":"center"}}},"editorScript":["file:./index.js"],"viewScript":["file:./view.js"],"editorStyle":["file:./index.css"],"style":["file:./style-index.css"]}');
...
function Edit({
  ...
  (0,_helpers__WEBPACK_IMPORTED_MODULE_5__.setAlignLayoutBackground)('stanza/accordion', clientId, setAttributes, backgroundColor, align, layout, parentId);

  // Default template
  const TEMPLATE = [["stanza/hero-text"] // TODO: proper template
  ];
...
// Overwrite supports using stanza.json options
_block_json__WEBPACK_IMPORTED_MODULE_1__ = (0,_helpers__WEBPACK_IMPORTED_MODULE_4__.supportsByOptions)('stanza/accordion', _block_json__WEBPACK_IMPORTED_MODULE_1__);

// Overwrite attributes defaults using stanza.json options
_block_json__WEBPACK_IMPORTED_MODULE_1__ = (0,_helpers__WEBPACK_IMPORTED_MODULE_4__.defaultsByOptions)('stanza/accordion', _block_json__WEBPACK_IMPORTED_MODULE_1__);
...
// Register styles using stanza.json options
(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.registerBlockStyles)('stanza/accordion');

// Register variations using stanza.json options
(0,_helpers__WEBPACK_IMPORTED_MODULE_4__.registerBlockVariations)('stanza/accordion');
})();

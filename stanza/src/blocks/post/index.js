...
import { post as postIcon } from '@wordpress/icons';
...
metadata = supportsByOptions('stanza/post', metadata);

// Overwrite attributes defaults using stanza.json options
metadata = defaultsByOptions('stanza/post', metadata)

// Set options using stanza.json options
metadata = setBlockOptionsAttribute('stanza/post', metadata)
...
registerBlockStyles('stanza/post');

// Register variations using stanza.json options
registerBlockVariations('stanza/post');